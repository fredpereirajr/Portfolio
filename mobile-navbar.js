class MobileNavbar {
    constructor(mobileMenu, navList, navLinks) {
      ...
      this.handleClick = this.handleClick.bind(this); /*Quando chamava a callback, this.handleClick, na hora de chamar this.navList.classList.toggle(this.activeClass); o this
